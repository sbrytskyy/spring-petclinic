...
class ClinicServiceTests {
	...
	void shouldFindVets() {
		...
		Iterator<Specialty> iterator = vet.getSpecialties().iterator();
		assertThat(iterator.next().getName()).isEqualTo("dentistry");
		assertThat(iterator.next().getName()).isEqualTo("surgery");
	}
